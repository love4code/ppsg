...
const seed = async () => {
    try {
        // Connect to MongoDB
        await mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/ppsg-cms');
        ...
        const projects = [
            {
                ...
                description: 'A beautiful luxury pool installation featuring modern design and premium materials. This project showcases our commitment to excellence and attention to detail.',
            ...
            },
            {
                ...
                description: 'Complete renovation of an existing spa area, including new equipment installation and modern design updates.',
            ...
            },
            {
                ...
                description: 'Transformation of an outdated pool deck into a modern, functional space with new materials and improved layout.',
        ...
        const products = [
            {
                ...
                description: 'High-quality pool filter system designed for maximum efficiency and durability. Features advanced filtration technology.',
                price: 1299.99,
                isTaxable: true,
            ...
            },
            {
                ...
                description: 'Complete pool cleaning kit with all essential tools for maintaining a clean and healthy pool.',
                price: 89.99,
                isTaxable: true,
        ...
        const services = [
            {
                ...
                description: 'Professional pool installation service. We handle everything from design to completion, ensuring your new pool meets all your needs and exceeds your expectations.',
                basePrice: 50000.00,
                mainImage: createdMedia[0]._id,
                status: 'published',
            },
            {
                ...
                description: 'Regular pool maintenance service to keep your pool clean, safe, and in perfect condition year-round.',
                basePrice: 150.00,
            ...
            },
            {
                ...
                description: 'Expert pool repair services for all types of issues. Fast, reliable, and affordable solutions.',
                mainImage: createdMedia[5]._id,
                status: 'published',
            },
        ];
